'use client'
import { InputText, Template, FieldError } from "@/components"
...
export default function FormularioPage(){
    ...
    async function handleSubmit(dados: FormProps){
        ...
        notification.notify('Upload sent sucessfuly!', 'success')
    }
            ...
            <section className="flex flex-col items-center justify-center my-5">
                ...
                <form onSubmit={formik.handleSubmit}>
                    ...
                    <div className="grid grid-cols-1 mt-5">
                        ...
                        <InputText id="tags"  onChange={formik.handleChange} placeholder="type the tags's comma separated"   value={formik.values.tags}/>
                    ...
                    <div className="mt-2 flex justify-center border rounded-lg border-dashed border-gray-900/25 px-6 py-10">
